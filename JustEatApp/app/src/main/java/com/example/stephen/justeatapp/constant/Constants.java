package com.example.stephen.justeatapp.constant;


public class Constants {

    //Base URL
    public static final String BASE_URL = "https://public.je-apis.com/restaurants/";
    ...
    public static final String VALUE = "se19";
}